...
class TestTypePredicatesWithVariables(unittest.TestCase):
...
class TestTypePredicatesWithLogicalOperators(unittest.TestCase):
...
class TestTypePredicatesWithExpressions(unittest.TestCase):
...
class TestTypePredicatesNegativePaths(unittest.TestCase):
